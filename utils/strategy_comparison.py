...
class StrategyComparator:
            ...
            for eps in epsilons:
                for run in range(self.runs_per_strategy):
                    ...
                    result = {
                        ...
                        "coverage": vacuum.metrics.calculate_coverage(
                            self.grid_size**2
                        ),
    ...
    def generate_report(self):
        ...
        for strategy in self.strategies:
            ...
            report[strategy] = {
                ...
                "success_rate": len([r for r in results if r["dirt_cleaned"] >= 6])
                / len(results),
            }
    ...
    def save_results(self, filename="comparison_results.json"):
        ...
        with open(filename, "w") as f:
            json.dump(
                {"summary": self.generate_report(), "raw_results": self.results},
                f,
                indent=2,
            )
        return filename
